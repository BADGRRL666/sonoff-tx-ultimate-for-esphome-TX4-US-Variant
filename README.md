This is purely a fork that adds extra lambda functions for the 4 button variant of the switch model.

The UART position output is as follows:
...
substitutions:
  name: "whatever_goes_here"
  friendly_name: "whatever goes here"
  ...
  nightlight_color: "{89,40,0}"

  latitude: "50.123456°"
  longitude: "5.654321°"

  touch_brightness: "1"
  touch_color: "{100,0,100}"
  touch_effect: "Scan"

  long_press_brightness: "1"
  long_press_color: "{0,0,0}"
  long_press_effect: "Rainbow"

  multi_touch_brightness: "1"
  multi_touch_color: "{100,0,100}"
  multi_touch_effect: "Scan"

  swipe_left_brightness: "1"
  swipe_left_color: "{0,0,0}"
  swipe_left_effect: "Rainbow"

  swipe_right_brightness: "1"
  swipe_right_color: "{0,0,0}"
  swipe_right_effect: "Rainbow"
...
# New
      - if:
          condition:
            lambda: "return (${relay_count}==4 && id(relay_3).state) || (${relay_count}==1 && id(relay_1).state);"
          then:
            - script.execute: led_on_button_middle
          else:
            - script.execute: led_off_button_middle
